...
//        list.forEach(s -> model.addRow(s.toDataRow()));
    ...
    private void fillForm() {
        ...
        txtDate1.setText(km.getNgayBD());
        txtDate2.setText(km.getNgayKT());
...
//        String ngay = date.toString();
        txtDate1.setText(sdf.format(date));
    }
    ...
    private KhuyenMaiReponse getKM() {
        ...
        km.setSoTienKM(bg);
        km.setNgayBD(txtDate1.getText());
        km.setNgayKT(txtDate2.getText());
    ...
    private Boolean check() {
        ...
        if (txtDate1.getText().trim().length() == 0 || txtDate2.getText().trim().length() == 0) {
            JOptionPane.showMessageDialog(this, "Không để trống ngày", "ERROR", JOptionPane.WARNING_MESSAGE);
            return false;
        }

        String date = "^\\d{4}-\\d{2}-\\d{2}$";
        if (!txtDate1.getText().matches(date) || !txtDate2.getText().matches(date)) {
            JOptionPane.showMessageDialog(this, "Sai định dạng ngày (yyyy-MM-dd)", "ERROR", JOptionPane.WARNING_MESSAGE);
            return false;
        }
